...
Hi!! I am Shyam Nandan Rai, currently working as a research assistant at CVIT, IIITH. Currently, I am involved in a project working on the vision and safety problems related to autonomous systems. In this project, we address the problem of minimizing the rain streaks in the images by few-shot self-supervised methods and using reconstructed images to improve computer vision tasks such as pedestrian detection that are critical to autonomous systems. My current research interest specifically lies in GANs, Semantic Segmentation, and problems related to the imbalance in large-scale datasets.
